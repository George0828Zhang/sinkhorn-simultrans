#!/usr/bin/env bash
SPLIT=test
EXP=/home/george/Projects/sinkhorn-simultrans/expcwmt
SRC=en
TGT=zh
DATA=/media/george/Data/cwmt/zh-en/data-bin
FAIRSEQ=/home/george/Projects/sinkhorn-simultrans/fairseq
